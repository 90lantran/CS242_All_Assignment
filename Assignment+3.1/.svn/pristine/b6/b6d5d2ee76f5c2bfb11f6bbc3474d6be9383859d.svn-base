 ...
 * The following JS will automatically jump the page to the commect post part
 */
    ...
    <div id="page" class="container">
        <div id="content">
            ...
            <div id="two-column">
                ...
                <div id='tbox2'>
                    <div class='box-style'>
                        <iframe src="iframe.html" name = "myIframe" width="500" height="400">
                    ...
                    <div class='box-style'>
                        ...
                        <div id='wrapper'>
                            ...
                            <ul>
                                <?php 
                                /* 
                                 * Print the comment table by calling getComments()
                                 */
