					...
					if (MoveValidCheck.isValidMove(chosenPieceIndex, moveLocationIndex)) {
						...
						if (MyGame.currentState != MyGame.PLAYING) {
							if (MyGame.currentState == MyGame.WHITE_WIN) {
								...
								whiteScoreLabel.setText("White Player Score "+ MyGame.whitePlayerScore);
							} else {
								...
								MyGame.undoAvailable = 0;
								blackScoreLabel.setText("Black Player Score "+ MyGame.blackPlayerScore);
							}
						}
		...
		public void actionPerformed(ActionEvent e) {
			if (MyGame.currentState != MyGame.NOPLAYING) {
				...
				if (n == 0 && m == 0) {
					...
					whiteScoreLabel.setText("White Player Score "+ MyGame.whitePlayerScore);
					blackScoreLabel.setText("Black Plyaer Score "+ MyGame.blackPlayerScore);
					...
					JOptionPane.showMessageDialog(null,"Restart fail. Please keep playing this Battle.", null,JOptionPane.WARNING_MESSAGE);
				}
			} else {
