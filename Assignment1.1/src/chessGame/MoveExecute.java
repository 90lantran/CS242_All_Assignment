...
/*
 * This class will move the picked piece to 
 * the chosen location. It should only be called
 * after MoveValidCheck.
 */
public class MoveExecute extends Pieces {
	...
	public static void executeMove(int piecePosition, int movePosition) {
		...
		// If there is an enemy at the move-to position Kill the enemy, update the board
	...
	/*
	 * This private function will move the picked piece to 
	 * the chosen valid location.
	 */
	...
	/*
	 * This private function will kill the enemy one the chosen location
	 */
