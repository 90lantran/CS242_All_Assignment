...
public class MyGame extends java.awt.Canvas {
	...
	public static int undoAvailable = 0;
	
	public static int whiteLastPickLocation;
	public static int whiteLastPickPiece;
	public static int whiteLastMoveLocation;
	public static int whiteLastMovePiece;
	public static JButton whiteLastPickButton;
	public static JButton whiteLastMoveButton;
	public static ImageIcon whiteLastPickIcon;
	public static ImageIcon whiteLastMoveIcon;
	
	public static int blackLastPickLocation;
	public static int blackLastPickPiece;
	public static int blackLastMoveLocation;
	public static int blackLastMovePiece;
	public static JButton blackLastPickButton;
	public static JButton blackLastMoveButton;
	public static ImageIcon blackLastPickIcon;
	public static ImageIcon blackLastMoveIcon;
